    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='snipher.profile')),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, null=True, to='snipher.Tag')),
            ],
        ),
    ]
